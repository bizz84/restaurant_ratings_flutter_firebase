...
import 'package:restaurant_ratings_flutter_firebase/app/sign_in/sign_in_view_model.dart';
import 'package:restaurant_ratings_flutter_firebase/app/sign_in/sign_in_button.dart';
  ...
  Future<void> _showEmailPasswordSignInPage(BuildContext context) async {
    ...
    await navigator.push(
      MaterialPageRoute<dynamic>(
        builder: (_) =>
            EmailPasswordSignInPage(onSignedIn: () => navigator.pop()),
